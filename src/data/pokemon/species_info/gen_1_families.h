...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_POLIWHIRL] =
    {
        ...
        .teachableLearnset = sPoliwhirlTeachableLearnset,
                .evolutions = EVOLUTION({EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                                {EVO_LEVEL, 40, SPECIES_POLITOED, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .formSpeciesIdTable = sSlowpokeFormSpeciesIdTable,
                .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_SLOWBRO, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 37, SPECIES_SLOWKING, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_MAGNETON] =
    {
        ...
        .evolutions = EVOLUTION(
            {EVO_LEVEL, 40, SPECIES_MAGNEZONE,
                CONDITIONS({IF_IN_MAP, MAP_MERIDIAN_POWER_SUBSTATION})}
        ),
    #endif
    },
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    #if P_GEN_2_CROSS_EVOS
                .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_STEELIX}),
    #endif
    },
    ...
    #if P_GEN_2_CROSS_EVOS
                .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_KINGDRA}),
    #endif
    },
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .eggMoveLearnset = sScytherEggMoveLearnset,
                ...
                .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_SCIZOR}),
    #endif
    },
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .evolutions = EVOLUTION(
            ...
            {EVO_LEVEL, 0, SPECIES_ESPEON,
                CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD},
                           {IF_NOT_TIME, TIME_NIGHT})},
            {EVO_LEVEL, 0, SPECIES_UMBREON,
                CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD},
                           {IF_TIME, TIME_NIGHT})},
            {EVO_LEVEL, 0, SPECIES_LEAFEON,
                CONDITIONS({IF_IN_MAP, MAP_BRAMBLEWOOD_MOSS_GROVE})},
            {EVO_LEVEL, 0, SPECIES_GLACEON,
                CONDITIONS({IF_IN_MAP, MAP_FROSTPEAK_ICE_GROTTO})}
        ),
    },
    ...
    #if P_GEN_2_CROSS_EVOS
                .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_PORYGON2}),
    #endif
    },
    ...
    #if P_GEN_4_CROSS_EVOS
                .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_PORYGON_Z}),
    #endif
    },
